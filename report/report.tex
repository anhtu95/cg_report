...
Để biểu diễn Trapezoidal map ta chỉ cẩn sử dụng một danh sách bản ghi, mỗi bản ghi tương ứng với mỗi hình thang và được biểu diễn bởi 4 điểm top,bottom,left,right. 
